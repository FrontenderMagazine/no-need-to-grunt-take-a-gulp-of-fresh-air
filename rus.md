...
файл в gulp, а затем сохраняете результат в другой файл. Всё очень просто.
...
Всё это трудно осмыслить без примеров кода, так что я продемонстрирую вам два 
...
В конечном счете, всё сводится к личным предпочтениям: лично я предпочитаю
«node-подобный» путь в написании моих таск-файлов с gulp. И, всё же, я должен
